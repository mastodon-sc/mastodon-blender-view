...
_CHANGEID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_COLORS_REQUEST', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SELECTED_TAG_SET', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_SELECTEDTAGSETRESPONSE = _descriptor.Descriptor(
  name='SelectedTagSetResponse',
  full_name='mastodon_blender_view.SelectedTagSetResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='mastodon_blender_view.SelectedTagSetResponse.index', index=0,
...
DESCRIPTOR.message_types_by_name['SelectedTagSetResponse'] = _SELECTEDTAGSETRESPONSE
...
SelectedTagSetResponse = _reflection.GeneratedProtocolMessageType('SelectedTagSetResponse', (_message.Message,), {
  'DESCRIPTOR' : _SELECTEDTAGSETRESPONSE,
  '__module__' : 'mastodon_blender_view_pb2'
  # @@protoc_insertion_point(class_scope:mastodon_blender_view.SelectedTagSetResponse)
  })
_sym_db.RegisterMessage(SelectedTagSetResponse)
...
_VIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getSelectedTagSet',
    full_name='mastodon_blender_view.ViewService.getSelectedTagSet',
    index=8,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_SELECTEDTAGSETRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
