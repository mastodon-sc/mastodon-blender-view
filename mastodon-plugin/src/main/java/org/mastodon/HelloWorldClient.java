	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length > 0) {
			if ("--help".equals(args[0])) {
				...
				System.err.println("");
				System.err.println(
					"  name    The name you wish to be greeted by. Defaults to " + user);
		...
		try {
			...
			// prevent leaking these
			// resources the channel should be shut down when it will no longer be
			// used. If it may be used
